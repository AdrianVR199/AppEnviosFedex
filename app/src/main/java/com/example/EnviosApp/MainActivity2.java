...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList_AS.add("Peru");
        arrayList_AS.add("Uruguay");
        ...
        arrayList_E.add("");
        arrayList_E.add("Holanda");
        arrayList_E.add("Italia");
        arrayList_E.add("Alemania");
        arrayList_E.add("Irlanda");

        //============ Asia =======

        arrayList_A = new ArrayList<>();
        arrayList_A.add("");
        arrayList_A.add("Afganistán");
    ...
    public void consulta (View v) {
        ...
        AppDb admin = new AppDb(this , "administracion",null,1);
